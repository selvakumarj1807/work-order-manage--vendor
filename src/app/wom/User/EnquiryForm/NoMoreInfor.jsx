    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-evenly" }}>
        <div style={{ display: "flex" }}>
          <h4>Year - </h4>
          <p style={{ marginTop: "5px", marginLeft:'5px', fontSize:'32px', fontWeight:'650', color:'red' }}>2009</p>
        </div>
        <div style={{ display: "flex" }}>
          <h4>Make - </h4>
          <p style={{ marginTop: "5px", marginLeft:'5px', fontSize:'32px', fontWeight:'650', color:'red' }}>Audi</p>
        </div>
        <div style={{ display: "flex" }}>
          <h4>Model - </h4>
          <p style={{ marginTop: "5px", marginLeft:'5px', fontSize:'32px', fontWeight:'650', color:'red' }}>A4</p>
        </div>
      </div>
            ...
            {(close) => (
              <div style={{ height: "40vh" }}>
                ...
                <button style={{ marginLeft: "48%" }}>
                  <Link to="/dashboard/default" style={{ color: "#fff" }}>
                    Done
                  </Link>
                </button>
              </div>
